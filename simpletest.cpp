 // VU Algorithmen und Datenstrukturen 1 - SS 2021 Universitaet Wien
 // https://cewebs.cs.univie.ac.at/ADS/ss21/
 //
 ...
 #ifndef -DETYPE=std::string
 #error -DETYPE=std::string not defined - compile with option -DETYPE=type
 #else
